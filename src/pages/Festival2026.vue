  ...
  <div class="festival-page">
    ...
    <section class="section container">
      ...
      <div class="agenda-wrapper max-w-xl mx-auto">
        <DayAgenda
          v-for="(day, idx) in festivalData.schedule"
          :key="idx"
          v-bind="day"
        />
      </div>
      ...
      <div class="container text-center">
        ...
        <div class="grid grid-3 gap-12">
          ...
          <div class="artist-card animate-fade">
            <div class="artist-image-wrapper">
              <img
                src="https://images.unsplash.com/photo-1514525253344-f814d072e507?q=80&w=600&auto=format&fit=crop"
                alt="Carol Benigno"
                class="bw-img"
                referrerpolicy="no-referrer"
                loading="lazy"
            ...
            <p class="artist-role text-upper">
              {{ t("festival.instrument_percussion") }}
            </p>
          </div>
          ...
          <div class="artist-card animate-fade">
            ...
            <p class="artist-role text-upper">
              {{ t("festival.instrument_accordion") }}
            </p>
          </div>
        </div>
      </div>
    ...
    <section
      id="tickets"
      class="section bg-light-orange flex flex-col items-center"
    >
      <div class="container text-center">
        ...
        <div
          class="cta-actions max-w-4xl mx-auto flex gap-12 flex-col items-center"
        >
